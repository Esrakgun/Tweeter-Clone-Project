    ...
    return (
        <div className="flex justify-between">
            <div className="text-tw-blue text-xl flex gap-4">
                ...
                <button type="button" className="form-icon"> <Gif /> </button>
                <button type="button" className="form-icon"> <Smile /> </button>
            </div>

            <button
                disabled={isLoading}
                className="bg-secondary font-bold px-5 py-[6px] rounded-full text-primary r-tracking-wide hover:brightness-75  min-w-[100px] transition cursor-pointer flex justify-center">
