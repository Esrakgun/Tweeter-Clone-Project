...
const TextArea = () => {
  console.log("text area render oldu mu?");
...
/*
 * text area component'ı hiç bir prop almadğı için kapsayıcı elemanın render olmasından olmasından dolayı gereksiz yere render oluyor
